...
class ResourceLoaderDelegate: NSObject, AVAssetResourceLoaderDelegate, URLSessionDataDelegate, URLSessionTaskDelegate {
    ...
    weak var owner: DownloadablePlayerItem?
...
extension ResourceLoaderDelegate: URLSessionDelegate {
...
private extension ResourceLoaderDelegate {
